...
SAPIEN_NO_DISPLAY=1 python -m mshab.train_sac configs/sac_pick_and_place.yml \
        ...
        env.spawn_data_fp="$MS_ASSET_DIR/data/scene_datasets/replica_cad_dataset/rearrange/spawn_data/$TASK/$SUBTASK/$SPLIT/spawn_data-0.pt" \
        ...
        eval_env.spawn_data_fp="$MS_ASSET_DIR/data/scene_datasets/replica_cad_dataset/rearrange/spawn_data/$TASK/$SUBTASK/$SPLIT/spawn_data-0.pt" \
